...
public class EventHubToBlob
{
    ...
    public async Task Primary([EventHubTrigger("eh1", Connection = "EventHubCnnStr")] EventData[] events,PartitionContext partitionContext,IBinder binder,ILogger log)
    {
        log.LogInformation($"C# function triggered to process a message: {events}");
